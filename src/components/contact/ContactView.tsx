      ...
      <div className="relative mx-auto w-full max-w-6xl px-6 py-16 sm:px-10 sm:py-20 lg:py-24">
        <div className="grid gap-14 lg:grid-cols-2 lg:items-start lg:gap-16 xl:gap-20">
          ...
          <div className={`min-w-0 ${lang === "he" ? "text-right" : ""}`}>
            ...
            >
              {tx(t.contact.info.body, lang)}
            </p>

            <ul className="mt-10 space-y-8 sm:mt-12">
              <li className={`flex gap-4 ${lang === "he" ? "flex-row-reverse" : ""}`}>
                <IconBox>
                ...
                <div className={lang === "he" ? "text-right" : ""}>
                  <p className="font-label text-xs font-medium uppercase tracking-wider transition-colors duration-300" style={{ color: "var(--text-muted)" }}>{tx(t.contact.info.emailLabel, lang)}</p>
              ...
              <li className={`flex gap-4 ${lang === "he" ? "flex-row-reverse" : ""}`}>
                ...
                <div className={lang === "he" ? "text-right" : ""}>
                  <p className="font-label text-xs font-medium uppercase tracking-wider transition-colors duration-300" style={{ color: "var(--text-muted)" }}>{tx(t.contact.info.phoneLabel, lang)}</p>
              ...
              <li className={`flex gap-4 ${lang === "he" ? "flex-row-reverse" : ""}`}>
                ...
                <div className={lang === "he" ? "text-right" : ""}>
                  <p className="font-label text-xs font-medium uppercase tracking-wider transition-colors duration-300" style={{ color: "var(--text-muted)" }}>{tx(t.contact.info.hqLabel, lang)}</p>
            ...
            <div className={`mt-10 flex flex-col gap-3 sm:flex-row sm:mt-12 ${lang === "he" ? "sm:flex-row-reverse" : ""}`}>
              <a
                href={`mailto:${CONTACT.email}`}
                className="inline-flex flex-1 items-center justify-center gap-2.5 rounded-xl bg-sky-500 px-6 py-3.5 text-sm font-semibold text-white shadow-sm transition-all hover:bg-sky-600 hover:shadow-md sm:text-base"
              >
                <svg className="h-5 w-5" viewBox="0 0 24 24" fill="none" aria-hidden>
                  <path d="M4 6h16v12H4V6Z" stroke="currentColor" strokeWidth="1.5" />
                  <path d="m4 7 8 5 8-5" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" />
                </svg>
                {tx(t.contact.info.emailCta, lang)}
              </a>
              <a
                href={CONTACT.whatsappHref}
                target="_blank"
                rel="noopener noreferrer"
                className="inline-flex flex-1 items-center justify-center gap-2.5 rounded-xl bg-[#25D366] px-6 py-3.5 text-sm font-semibold text-white shadow-sm transition-all hover:bg-[#1ebe5d] hover:shadow-md sm:text-base"
              >
                ...
                {tx(t.contact.info.whatsappCta, lang)}
              </a>
            </div>

            <div className={`mt-12 sm:mt-14 ${lang === "he" ? "text-right" : ""}`}>
              <p className="font-label text-[11px] font-semibold uppercase tracking-[0.22em] transition-colors duration-300" style={{ color: "var(--text-muted)" }}>
                {tx(t.contact.info.socialLabel, lang)}
              </p>
              <div className={`mt-4 flex flex-wrap gap-3 ${lang === "he" ? "justify-end" : ""}`}>
