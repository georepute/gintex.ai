...
const SIGNALS = [
  ...
  { label: "Digital reputation",       icon: "M11.049 2.927c.3-.921 1.603-.921 1.902 0l1.519 4.674a1 1 0 0 0 .95.69h4.915c.969 0 1.371 1.24.588 1.81l-3.976 2.888a1 1 0 0 0-.363 1.118l1.518 4.674c.3.922-.755 1.688-1.538 1.118l-3.976-2.888a1 1 0 0 0-1.176 0l-3.976 2.888c-.783.57-1.838-.197-1.538-1.118l1.518-4.674a1 1 0 0 0-.363-1.118l-3.976-2.888c-.784-.57-.38-1.81.588-1.81h4.914a1 1 0 0 0 .951-.69l1.519-4.674z" },
  { label: "Market perception",        icon: "M3 3h2l.4 2M7 13h10l4-8H5.4M7 13 5.4 5M7 13l-2.293 2.293c-.63.63-.184 1.707.707 1.707H17m0 0a2 2 0 1 0 0 4 2 2 0 0 0 0-4zm-8 2a2 2 0 1 0 0 4 2 2 0 0 0 0-4z" },
  ...
  { label: "Search representation",    icon: "M21 21l-6-6m2-5a7 7 0 1 1-14 0 7 7 0 0 1 14 0z" },
  { label: "Competitive positioning",  icon: "M9 19v-6a2 2 0 0 0-2-2H5a2 2 0 0 0-2 2v6a2 2 0 0 0 2 2h2a2 2 0 0 0 2-2zm0 0V9a2 2 0 0 0-2-2H5a2 2 0 0 0-2 2v10m6 0a2 2 0 0 0 2 2h2a2 2 0 0 0 2-2m0 0V5a2 2 0 0 0-2-2h-2a2 2 0 0 0-2 2v14" },
  { label: "Narrative consistency",    icon: "M9 12h6m-6 4h6m2 5H7a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h5.586a1 1 0 0 1 .707.293l5.414 5.414a1 1 0 0 1 .293.707V19a2 2 0 0 1-2 2z" },
];

const REPORTS = [
  { label: "AI Visibility Intelligence",      grad: "from-sky-500 to-cyan-400",      bg: "rgba(14,165,233,0.08)",  border: "rgba(14,165,233,0.2)"  },
  { label: "Reputation Intelligence",          grad: "from-violet-500 to-purple-400", bg: "rgba(139,92,246,0.08)",  border: "rgba(139,92,246,0.2)"  },
  { label: "Competitive Analysis",             grad: "from-teal-500 to-emerald-400",  bg: "rgba(20,184,166,0.08)",  border: "rgba(20,184,166,0.2)"  },
  { label: "SEO & GEO Diagnostics",           grad: "from-blue-500 to-indigo-400",   bg: "rgba(99,102,241,0.08)",  border: "rgba(99,102,241,0.2)"  },
  { label: "Market Entry Analysis",            grad: "from-cyan-500 to-sky-400",      bg: "rgba(6,182,212,0.08)",   border: "rgba(6,182,212,0.2)"   },
  { label: "Authority Mapping",                grad: "from-indigo-500 to-blue-400",   bg: "rgba(79,70,229,0.08)",   border: "rgba(79,70,229,0.2)"   },
  { label: "Political & Public Intelligence",  grad: "from-rose-500 to-pink-400",     bg: "rgba(244,63,94,0.08)",   border: "rgba(244,63,94,0.2)"   },
  { label: "Executive Reputation Analysis",    grad: "from-amber-500 to-yellow-400",  bg: "rgba(245,158,11,0.08)",  border: "rgba(245,158,11,0.2)"  },
];
